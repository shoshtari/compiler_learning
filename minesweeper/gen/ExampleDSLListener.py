...
class ExampleDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExampleDSLParser#hint_types.
    def enterHint_types(self, ctx:ExampleDSLParser.Hint_typesContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#hint_types.
    def exitHint_types(self, ctx:ExampleDSLParser.Hint_typesContext):
        pass
