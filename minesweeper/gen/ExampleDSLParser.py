...
class ExampleDSLParser ( Parser ):
    ...
    ruleNames =  [ "start", "program", "output", "output_types", "hint", 
                   "hint_types", "initiate_game", "width", "height", "bomb_placements", 
    ...
    class HintContext(ParserRuleContext):
        ...
        def hint_types(self):
            return self.getTypedRuleContext(ExampleDSLParser.Hint_typesContext,0)
    ...
    def hint(self):
        ...
        self.enterRule(localctx, 8, self.RULE_hint)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 43
    ...
    class Hint_typesContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return ExampleDSLParser.RULE_hint_types

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterHint_types" ):
                listener.enterHint_types(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitHint_types" ):
                listener.exitHint_types(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitHint_types" ):
                return visitor.visitHint_types(self)
            else:
                return visitor.visitChildren(self)
    ...
    def hint_types(self):
        ...
        localctx = ExampleDSLParser.Hint_typesContext(self, self._ctx, self.state)
        self.enterRule(localctx, 10, self.RULE_hint_types)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 46
